    ...
    const mobileStyles = `
        <style>
            @media (max-width: 768px) {
                .main-contact-content-mobile {
                    max-width: 95% !important;
                    padding: 30px 15px !important;
                    margin: 0 auto !important;
                }
                
                .other-contact-section-mobile {
                    max-width: 95% !important;
                    padding: 30px 15px !important;
                    margin: 0 auto !important;
                }
        ...
        <>
            ...
            <div className="page-frame">
                <div className="home-window">
                    ...
                    <div className="main-contact-content main-contact-content-mobile" style={{
                        maxWidth: '600px',
                        margin: '0 auto',
                        padding: '40px 20px'
                    }}>
                        ...
                        {submitStatus === 'success' && (
                            <div className="status-message-mobile" style={{
                                background: '#d4edda',
                        ...
                        <form id="contact-form" className="contact-form" onSubmit={handleSubmit}>
                            <div className="form-field-mobile" style={{ marginBottom: '24px' }}>
                                <label htmlFor="name" className="form-label-mobile" style={{
                                    display: 'block',
                                    fontWeight: '600',
                                    marginBottom: '8px',
                                    color: '#171313'
                                ...
                                <input
                                    ...
                                    required
                                    className="contact-form-input-mobile"
                                    style={{
                                        width: '100%',
                                        padding: '12px 16px',
                            ...
                            <div className="form-field-mobile" style={{ marginBottom: '24px' }}>
                                <label htmlFor="email" className="form-label-mobile" style={{
                                    display: 'block',
                                    fontWeight: '600',
                                    marginBottom: '8px',
                                    color: '#171313'
                            ...
                            <div className="form-field-mobile" style={{ marginBottom: '32px' }}>
                                <label htmlFor="message" className="form-label-mobile" style={{
                                    display: 'block',
                                    fontWeight: '600',
                                    marginBottom: '8px',
                                    color: '#171313'
                                ...
                                <textarea
                                    ...
                                    required
                                    rows={6}
                                    className="contact-form-textarea-mobile"
                                    style={{
                                        width: '100%',
                                        padding: '12px 16px',
                                        border: '1px solid #171313',
                            ...
                            <button
                                ...
                                className="submit-button submit-button-mobile"
                                style={{
                                    width: '100%',
                                    padding: '16px 32px',
                    ...
                    <div className="other-contact-section other-contact-section-mobile" style={{
                        maxWidth: '600px',
                        margin: '0 auto',
                        padding: '40px 20px',
                        textAlign: 'center'
                        ...
                        <div className="contact-methods contact-methods-mobile" style={{
                            display: 'flex',
                            ...
                            {siteSettings?.email && (
                                <a 
                                    ...
                                    className="contact-method-link contact-method-link-mobile"
                                    style={{
                                        display: 'inline-flex',
                                        alignItems: 'center',
                                        gap: '12px',
